...
export const editableRootStyle = {
  ...
  '--slot4-accent': '#ffc928',
  '--slot4-accent-fill': '#ffc928',
  '--slot4-accent-soft': '#fff5cc',
  '--slot4-on-accent': '#102d68',
  '--slot4-dark-bg': '#102d68',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#eeeeee',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f4f5f7',
  '--slot4-lavender': '#65c9e5',
  '--slot4-gray': '#f7f7f7',
  '--slot4-body-gradient': 'none',
  '--editable-page-bg': '#ffffff',
  '--editable-page-text': '#1a1a1a',
  '--editable-container': '1180px',
  '--editable-border': '#dfe3eb',
  '--editable-nav-bg': '#17356f',
  '--editable-nav-text': '#ffffff',
  '--editable-nav-active': '#ffc928',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#ffc928',
  '--editable-cta-text': '#102d68',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#102d68',
